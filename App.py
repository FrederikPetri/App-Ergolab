...
from helpers import username_helper, screen_helper, navigation_helper, another_helper
...
sm.add_widget(RecordingScreen(name='optagelse'))
...
class ErgolabApp(MDApp):
    def build(self):
        ...
        screen = Builder.load_string(another_helper)
